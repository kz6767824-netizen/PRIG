...
![Migration SQL file in the PR](screenshots/github-01-migration-sql.png)
...
![Both checks queued](screenshots/github-02-checks-queued.png)
...
![Checks running](screenshots/github-03-checks-running.png)
...
![Both checks passed](screenshots/github-04-checks-passed.png)
...
![Full PR comment output: patches + impact report](screenshots/github-05-pr-comments-full-output.png)
...
![Document content with GitHub Actions source line](screenshots/datahub-01-document-content-source.png)
...
![DataHub Tags page showing 5 entities](screenshots/datahub-02-tags-page.png)
...
![Filtered list of all tagged entities](screenshots/datahub-03-tagged-entities-list.png)
