...
Ties together: parsed operations -> per-column lineage lookup -> per-operation
severity -> per-operation explanation -> one combined markdown report.
"""
...
# FIX: Proper Markdown horizontal rule with blank lines around it
DISCLAIMER = (
    "\n\n---\n\n"
